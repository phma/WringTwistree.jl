...
function testParallelTwistree(twistree::Twistree,plaintext,hashtext::Vector{UInt8})
  plaintext=Vector{UInt8}(plaintext)
  initialize!(twistree)
  update!(twistree,plaintext,:sequential)
  hashSeq=finalize!(twistree)
  initialize!(twistree)
  update!(twistree,plaintext,:parallel)
  hashPar=finalize!(twistree)
  ret=hashSeq==hashtext && hashPar==hashtext
  if !ret
    println("Expected hash: ",hashtext,"\nGot par: ",hashPar,"\nGot seq: ",hashSeq)
  end
  ret
...
@test testVectorWring(wring0,"EncipherMessage",
		      [ 0x29, 0xb5, 0x8f, 0xd1, 0x67, 0xa7, 0xb3, 0xf6
...
@test testVectorWring(wring6,"EncipherMessage",
		      [ 0x17, 0x95, 0x06, 0x84, 0x85, 0x6c, 0x0e, 0xed
...
@test testVectorWring(wring30,"EncipherMessage",
		      [ 0x9b, 0x21, 0x52, 0x31, 0x35, 0x7c, 0xb4, 0x51
...
@test testVectorWring(wring96,"EncipherMessage",
		      [ 0x5d, 0x6d, 0x0c, 0xa5, 0xfb, 0x0d, 0x38, 0x74
...
@test testParallelTwistree(twistree96,text59049,
